...
import { MentorshipCourse } from './mentorship-data.types.ts';
...
export const mentorshipCourses: MentorshipCourse[] = [
  ...
  {
    id: 2,
    courseName: COURSE_TITLES.REACT,
    lang: 'en',
  ...
  {
    id: 3,
    courseName: COURSE_TITLES.NODE,
    lang: 'en',
    pageUrl: ROUTES.NODE_JS,
    description: [
      'The duration of mentoring is 8 weeks',
      'Format: online',
      'A desire to mentor from 2 to 6 students online or in person',
      'An ability to dedicate 3 to 5 hours per week',
    ],
    ...
    mentorDocsUrl: 'https://github.com/rolling-scopes-school/docs/blob/master/docs/en/rs-school-mentor.md',
    courseDocsUrl: 'https://github.com/rolling-scopes-school/docs/blob/master/docs/en/node-js-en/course-overview.md',
    benefits: [
      'Opportunity to develop a new colleague',
      'Gaining new experience, search for new colleagues',
      'Opportunity to share knowledge',
  ...
  {
    id: 4,
    courseName: COURSE_TITLES.JS_EN,
    lang: 'en',
    pageUrl: ROUTES.JS,
    description: [
  ...
  {
    id: 5,
    courseName: COURSE_TITLES.JS_RU,
    lang: 'ru',
