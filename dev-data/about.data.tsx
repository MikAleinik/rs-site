    ...
    },
    {
      ...
      info: (
        <p>
          ...
          {' '}
          <LinkCustom href="/courses/javascript/#mentors-requirement">How to become a mentor?</LinkCustom>
        </p>
      ),
      icon: planetIcon,
    },
    ...
    },
    {
      ...
      info: (
        <p>
          ...
          {' '}
          <LinkCustom href="/courses/javascript-ru/#mentors-requirement">Как стать наставником?</LinkCustom>
        </p>
      ),
      icon: planetIcon,
    },
